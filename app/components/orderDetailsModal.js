...
const OrderDetailsModal = ({
  ...
  return (
    ...
    >
      {selectedOrder && (
        <div>
          <Descriptions title="Restaurant Information" bordered>
            <Descriptions.Item label="Restaurant Name" span={3}>
              {selectedOrder?.restaurantId?.name}
            </Descriptions.Item>
            <Descriptions.Item label="Restaurant Email" span={3}>
              {selectedOrder?.restaurantId?.email}
            </Descriptions.Item>
          </Descriptions>
